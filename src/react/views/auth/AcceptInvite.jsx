...
export default function AcceptInvite() {
  ...
  const { acceptInvite, loading, error } = useAuthStore()
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setErrorMessage(
        err.response?.data?.message || 'Failed to accept invite. The link may have expired.'
      )
    }
  }
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="bg-gray-50 px-4 py-3 rounded-md">
              ...
              <ul className="mt-2 text-xs text-gray-600 list-disc list-inside space-y-1">
                <li className={form.password.length >= 12 ? 'text-green-600' : undefined}>
            ...
            <div>
              ...
              >
                <span>{loading ? 'Accepting invite...' : 'Activate account'}</span>
              </button>
            </div>
          </form>
        ) : (
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-green-700">
                    <p>Your account is now active. You can log in with your new password.</p>
                  </div>
                </div>
              </div>
            </div>
