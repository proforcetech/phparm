...
/**
 * Phase 18 / C1 — Bearer token issued to a procurement vendor for self-service
 * portal access. Stored hashed; the plaintext is shown to the staff user
 * exactly once at issue time so they can hand it to the vendor.
 */
class VendorPortalToken extends BaseModel
{
    public int $id = 0;
