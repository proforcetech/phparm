<?php
/**
 * Admin Entry Point (Integrated)
 * FixItForUs CMS
 *
 * This file handles all admin panel routes when integrated with phparm
 * Called from the main application's public/index.php
 */
...
// Remove 'admin.php' or 'admin' prefix if present
$path = preg_replace('/^admin\.php\/?/', '', $path);
$path = preg_replace('/^admin\/?/', '', $path);
$path = preg_replace('/^cms-php\/admin\.php\/?/', '', $path);
$path = preg_replace('/^cms-php\/admin\/?/', '', $path);
$path = trim($path, '/');
