...
CREATE TABLE IF NOT EXISTS workorder_reassignment_requests (
    ...
    proposed_assignee_user_id INT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS workorder_reassignment_history (
    ...
    reassigned_by_user_id INT UNSIGNED NULL,
