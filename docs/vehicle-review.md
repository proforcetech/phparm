...
### Tasks
1. **Expose cascading vehicle option endpoints**
...
2. **Populate vehicle master data**
...
### Tasks
1. **Implement full customer vehicle persistence**
...
2. **Add customer-facing vehicle management**
