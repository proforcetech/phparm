...
### Tasks
1. [x] **Add reminder preferences table and model**
...
2. [x] **Expose preference capture/update flows**
...
### Tasks
1. [x] **Expand campaign schema and service**
...
2. [x] **Add reminder logs persistence and APIs**
...
### Tasks
1. [x] **Enhance scheduling logic and templating**
...
2. [x] **Record delivery attempts and failures**
