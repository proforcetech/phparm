...
### Tasks
1. **Add customer-facing claim list and detail endpoints**
...
2. **Enable customer replies on open claims**
...
### Tasks
1. **Create warranty claim messages schema**
...
2. **Persist and expose conversations**
